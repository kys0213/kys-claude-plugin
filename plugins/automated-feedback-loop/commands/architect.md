...
```bash
# 새 설계 시작
/afl:architect "결제 시스템에 쿠폰 할인 기능 추가"
...
│                                                               │
│  • session-id 생성 (8자리)                                    │
│  • .afl/sessions/{session-id}/ 디렉토리 생성                  │
│  • meta.json 초기화                                           │
└───────────────────────────────────────────────────────────────┘
        │
        ▼
...
│                                                               │
│  "설계 완료! 구현을 위임하시겠습니까?"                       │
│  → /afl:delegate --session {session-id}                      │
└───────────────────────────────────────────────────────────────┘
```
...
/afl:architect --list 로 전체 목록을 확인하세요.
```
...
⏸️ Checkpoint 승인 대기 중
  ...
  승인 후 구현 위임이 가능합니다.
  /afl:architect --resume abc12345 로 계속 진행하세요.
```
