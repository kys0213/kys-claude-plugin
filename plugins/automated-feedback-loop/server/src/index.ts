 ...
 * AFL Server
 *
 * Automated Feedback Loop 로컬 HTTP 서버.
...
// 설정
const PORT = parseInt(process.env.AFL_PORT || "7890", 10);
const DATA_DIR = process.env.AFL_DATA_DIR || ".afl/server-data";
const EXECUTOR = process.env.AFL_EXECUTOR; // 미지정 시 자동 선택
