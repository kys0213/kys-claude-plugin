...
use atelier::autopilot::cmd::epic::{EpicService, EpicStatusFilter};
use atelier::autopilot::domain::{Epic, EpicStatus, EventKind, TaskId, TaskStatus};
            ...
            EpicPlan {
                ...
                tasks: vec![
                    NewTask {
                        ...
                        source: atelier::autopilot::domain::TaskSource::Decompose,
                        fingerprint: None,
                        title: "first".into(),
                        body: None,
                    },
