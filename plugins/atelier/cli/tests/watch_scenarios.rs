...
use atelier::autopilot::cmd::watch::ci::BranchFilter;
use atelier::autopilot::cmd::watch::{TickState, WatchArgs, WatchEvent, WatchService};
use atelier::autopilot::domain::{Epic, EpicStatus, TaskId, TaskSource, TaskStatus};
use atelier::autopilot::fs::FsOps;
use atelier::autopilot::ports::clock::{Clock, FixedClock};
use atelier::autopilot::ports::task_store::{EpicPlan, NewTask, NewWatchTask, TaskStore};
use atelier::autopilot::store::SqliteTaskStore;
...
fn scenario_github_and_ledger_emit_in_same_tick() {
    ...
    let github =
        Arc::new(
            MockGitHub::new().with_issues(vec![atelier::autopilot::github::OpenIssue {
                number: 42,
    ...
    let svc2 = WatchService::new(
        Arc::new(MockGitHub::new().with_issues(vec![
            atelier::autopilot::github::OpenIssue {
