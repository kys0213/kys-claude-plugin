...
use crate::autopilot::domain::event::{EventKind, EventPayload};
use crate::autopilot::domain::simhash::{hamming_distance, jaccard_similarity};
use crate::autopilot::domain::{Task, TaskId, TaskStatus};
use crate::autopilot::ports::task_store::{EventFilter, TaskStore};
...
/// shape of [`crate::autopilot::cmd::task::TaskService`] so wiring in `main.rs` is
/// uniform.
