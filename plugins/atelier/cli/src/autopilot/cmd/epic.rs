...
use crate::autopilot::domain::{DomainError, Epic, EpicStatus, TaskId, TaskSource, TaskStatus};
use crate::autopilot::ports::clock::Clock;
use crate::autopilot::ports::task_store::{
    ...
    pub fn create_with_options(
        ...
        if !spec_path.try_exists().unwrap_or(false) {
            return Err(anyhow::Error::new(
                crate::autopilot::domain::UserInputError::new(format!(
