...
```bash
/atelier:autopilot/analyze-issue             # 자동 탐색 (라벨 없는 open 이슈)
/atelier:autopilot/analyze-issue 42          # 단일 이슈
/atelier:autopilot/analyze-issue 42 43 44    # 복수 이슈
/atelier:autopilot/analyze-issue #42 #43     # # 접두사 허용
```
