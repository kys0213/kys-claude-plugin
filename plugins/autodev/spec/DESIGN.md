...
│   ├── claw-evaluate.sh        ← guard + autodev agent
│   ├── gap-detection.sh        ← guard + autodev agent
│   ├── knowledge-extract.sh    ← guard + autodev agent
│   ├── hitl-timeout.sh         ← guard + autodev agent
│   ├── daily-report.sh         ← guard + autodev agent
